      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
         ...
         @if(Session::has('id'))
          ...
          <li class="dropdown dropdown-hover">
            <a href="#!" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                    <span class="badge bg-default">2</span> <span class="caret"></span> <span class="label">{{ $select['username']}}</span>
                    </a>
            <div class="dropdown-menu">
              <ul role="menu">
                ...
                <li><a href="/user_profile">Profile <span class="badge pull-right bg-warning">13</span></a>
                </li>
